...
export class RequestsComponent {
  ...
  getReviewRequests() {
    this.apiService.getAllReviewRequest().subscribe(reviewsRequest => {
  ...
  approveReviewRequest(request: reviewRequest) {
    this.apiService.approveRequestOfReview(request).subscribe(result => {
      alert(result.message)
  ...
  rejectReviewRequest(request: reviewRequest) {
    this.apiService.rejectRequestOfReview(request).subscribe(result => {
      alert(result.message)
      this.updateRequests(request);
    })
  }
